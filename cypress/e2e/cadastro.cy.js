...
import { el } from '../support/pages/deliver/elements'
...
describe('Cadastro de entregador para Buger Eats', () => {
    ...
    it('Não deve efetuar cadastro selecionando 2 métodos de entrega Van/Carro e Moto', () => {
        ...
        cy.get(el.txtMensagemErroMetodoEntrega).should('be.visible').and('have.text', 'Oops! Selecione apenas um método de entrega')
    });
});